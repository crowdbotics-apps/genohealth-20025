"""genohealth_20025 URL Configuration
...
admin.site.site_header = "GenoHealth"
admin.site.site_title = "GenoHealth Admin Portal"
admin.site.index_title = "GenoHealth Admin"

# swagger
api_info = openapi.Info(
    title="GenoHealth API",
    default_version="v1",
    description="API documentation for GenoHealth App",
)
